...
namespace WebApi2Book.Web.Api.MaintenanceProcessing
{
    ...
    class ReactivateTaskWorkflowProcessor : IReactivateTaskWorkflowProcessor
    {
        ...
        public ReactivateTaskWorkflowProcessor(ITaskByIdQueryProcessor taskByIdQueryProcessor, IUpdateTaskStatusQueryProcessor updateTaskStatusQueryProcessor, IAutoMapper autoMapper, IDateTime dateTime)
        {
